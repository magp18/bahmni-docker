 ...
 * $translateProvider.useUrlLoader('/' + OPENMRS_CONTEXT_PATH +
 * '/module/uicommons/messages/messages.json')
 */
@Controller
public class MessagesController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, String>> getMessages(@RequestParam("localeKey") Locale localeKey,
